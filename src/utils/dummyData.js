...
export const gridData = [
    { 
        ...
        disc : "Invested shareholders must confirm payment and office address ",
        due : [{
            "Within 180" : "₹50,000 for the company"        }]
    },
    { 
        id : 2,
        title : "Auditor Appointment",
        disc : "Company informs new auditor and submits ADT.1 form to ROC.",
        due : [{
            "Within 30" : "₹300 per month.",
    ...
    { 
        id : 3,
        title : "DIN eKYC",
        disc : "Directors share personal information for identification & verification ",
        due : [{
            "Every Year " : "₹5000 one time",
    ...
    { 
        id : 4,
        title : "DPT-3",
        disc : "Companies report money taken from people to ROC; auditors confirm details.",
        due :[ {
            "Within 30 days " : "₹300 per month with no upper limits",
    ...
    { 
        ...
        disc : "It's like an official report card for a company's documents",
        due : [{
    ...
    { 
        ...
        disc : "Companies must annually report activities and finances to the registrar.",
        due : [{
            "On or Before 31st December" : "₹200 per day(No upper limit)* ",
